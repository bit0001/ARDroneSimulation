...
#include <stddef.h>
#include "blas.h"
#include "ARDrone2_DiscreteSimulation_sfun.h"
#include "c2_ARDrone2_DiscreteSimulation.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "ARDrone2_DiscreteSimulation_sfun_debug_macros.h"
...
static const char * c2_debug_family_names[25] = { "T0", "K_V_XY", "K_V_Z",
  "K_OMEGA_PSI", "V_REF", "PSI_REF", "Z", "x_ref_np1", "y_ref_np1", "z_ref_np1",
  "nargin", "nargout", "x_n", "y_n", "z_n", "psi_nm1", "psi_ez_nm1", "t",
  "V_xy_n", "V_z", "omega_psi_n", "x_ref_n", "y_ref_n", "z_ref_n", "psi_ez_n" };

/* Function Declarations */
static void initialize_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void initialize_params_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void enable_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void disable_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void set_sim_state_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance, const mxArray *
   c2_st);
static void finalize_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void sf_gateway_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void mdl_start_c2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void initSimStructsc2_ARDrone2_DiscreteSimulation
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber, uint32_T c2_instanceNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_ARDrone2_DiscreteSimulationInstanceStruct
...
static void c2_eml_scalar_eg(SFc2_ARDrone2_DiscreteSimulationInstanceStruct
  *chartInstance);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance, const mxArray *
   c2_b_is_active_c2_ARDrone2_DiscreteSimulation, const char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance, const mxArray *
   c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_ARDrone2_DiscreteSimulationInstanceStruct
  *chartInstance);
  ...
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_ARDrone2_DiscreteSimulation = 0U;
}
  ...
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance)
{
  ...
  c2_h_hoistedGlobal =
    chartInstance->c2_is_active_c2_ARDrone2_DiscreteSimulation;
   ...
   c2_st)
{
  ...
  *chartInstance->c2_z_ref_n = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_ARDrone2_DiscreteSimulation =
    c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 7)),
    "is_active_c2_ARDrone2_DiscreteSimulation");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_ARDrone2_DiscreteSimulation(chartInstance);
  ...
  (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance)
{
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_x_ref_np1, 7U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_y_ref_np1, 8U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_z_ref_np1, 9U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_nargout, 11U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_x_n, 12U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_y_n, 13U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_z_n, 14U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_psi_nm1, 15U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_psi_ez_nm1, 16U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c2_b_t, 17U, c2_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_V_xy_n, 18U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_V_z, 19U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_omega_psi_n, 20U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_x_ref_n, 21U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_y_ref_n, 22U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_z_ref_n, 23U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c2_b_psi_ez_n, 24U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_x_ref_np1 = 0.1 + 0.14142135623730953 * (c2_b_t + c2_T0);
  ...
  c2_eml_scalar_eg(chartInstance);
  c2_c = c2_d_a * c2_d_a;
  c2_y_ref_np1 = 0.1 + 0.1414213562373095 * c2_c;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 29);
  c2_z_ref_np1 = 1.2;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 31);
  c2_A = (c2_y_ref_np1 - 0.91 * (c2_b_y_ref_n - c2_b_y_n)) - c2_b_y_n;
  c2_B = (c2_x_ref_np1 - 0.91 * (c2_b_x_ref_n - c2_b_x_n)) - c2_b_x_n;
  c2_x = c2_A;
  c2_y = c2_B;
  c2_b_x = c2_x;
  c2_b_y = c2_y;
  ...
  c2_b_V_xy_n = 10.0 * (((c2_x_ref_np1 - 0.91 * (c2_b_x_ref_n - c2_b_x_n)) -
    c2_b_x_n) * c2_g_x + ((c2_y_ref_np1 - 0.91 * (c2_b_y_ref_n - c2_b_y_n)) -
    c2_b_y_n) * c2_i_x);
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 39);
  c2_b_V_z = 10.0 * ((c2_z_ref_np1 - 0.91 * (c2_b_z_ref_n - c2_b_z_n)) -
                     c2_b_z_n);
  ...
  *chartInstance->c2_psi_ez_n = c2_b_psi_ez_n;
  ...
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_ARDrone2_DiscreteSimulationMachineNumber_,
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance;
  chartInstance = (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_ARDrone2_DiscreteSimulation_get_eml_resolved_functions_info
  (void)
{
   ...
   c2_b_is_active_c2_ARDrone2_DiscreteSimulation, const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_ARDrone2_DiscreteSimulation), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_ARDrone2_DiscreteSimulation);
  return c2_y;
}
...
void sf_c2_ARDrone2_DiscreteSimulation_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3735997512U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3505083403U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2028527425U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3883581106U);
}

mxArray* sf_c2_ARDrone2_DiscreteSimulation_get_post_codegen_info(void);
mxArray *sf_c2_ARDrone2_DiscreteSimulation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wGpqEhhaBKHVUaG2zh60PF");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c2_ARDrone2_DiscreteSimulation_get_post_codegen_info();
...
mxArray *sf_c2_ARDrone2_DiscreteSimulation_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_ARDrone2_DiscreteSimulation_jit_fallback_info(void)
{
...
mxArray *sf_c2_ARDrone2_DiscreteSimulation_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_ARDrone2_DiscreteSimulation(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[5],T\"V_xy_n\",},{M[1],M[28],T\"V_z\",},{M[1],M[6],T\"omega_psi_n\",},{M[1],M[26],T\"psi_ez_n\",},{M[1],M[13],T\"x_ref_n\",},{M[1],M[14],T\"y_ref_n\",},{M[1],M[11],T\"z_ref_n\",},{M[8],M[0],T\"is_active_c2_ARDrone2_DiscreteSimulation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_ARDrone2_DiscreteSimulation_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _ARDrone2_DiscreteSimulationMachineNumber_,
           2,
           1,
           1,
           0,
        ...
        init_script_number_translation
          (_ARDrone2_DiscreteSimulationMachineNumber_,chartInstance->chartNumber,
           chartInstance->instanceNumber);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",152,-1,1364);
...
{
  return "mhdCE1HpctACDJ9jYMgjoG";
}

static void sf_opaque_initialize_c2_ARDrone2_DiscreteSimulation(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*) chartInstanceVar);
  initialize_c2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_ARDrone2_DiscreteSimulation(void
  *chartInstanceVar)
{
  enable_c2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_ARDrone2_DiscreteSimulation(void
  *chartInstanceVar)
{
  disable_c2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_ARDrone2_DiscreteSimulation(void
  *chartInstanceVar)
{
  sf_gateway_c2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c2_ARDrone2_DiscreteSimulation
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_ARDrone2_DiscreteSimulation(SimStruct* S,
  const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*)chartInfo->chartInstance,
     st);
}

static void sf_opaque_terminate_c2_ARDrone2_DiscreteSimulation(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_ARDrone2_DiscreteSimulation_optimization_info();
    }

    finalize_c2_ARDrone2_DiscreteSimulation
      ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_ARDrone2_DiscreteSimulation
    ((SFc2_ARDrone2_DiscreteSimulationInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_ARDrone2_DiscreteSimulation(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_ARDrone2_DiscreteSimulation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_ARDrone2_DiscreteSimulation_optimization_info();
  ...
  ssSetChecksum0(S,(3257337072U));
  ssSetChecksum1(S,(3773900342U));
  ssSetChecksum2(S,(3356299102U));
  ssSetChecksum3(S,(3288851932U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c2_ARDrone2_DiscreteSimulation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_ARDrone2_DiscreteSimulation(SimStruct *S)
{
  SFc2_ARDrone2_DiscreteSimulationInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_ARDrone2_DiscreteSimulationInstanceStruct *)utMalloc
    (sizeof(SFc2_ARDrone2_DiscreteSimulationInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_ARDrone2_DiscreteSimulationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_ARDrone2_DiscreteSimulation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_ARDrone2_DiscreteSimulation;
...
void c2_ARDrone2_DiscreteSimulation_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_ARDrone2_DiscreteSimulation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_ARDrone2_DiscreteSimulation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_ARDrone2_DiscreteSimulation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_ARDrone2_DiscreteSimulation_method_dispatcher.\n"
